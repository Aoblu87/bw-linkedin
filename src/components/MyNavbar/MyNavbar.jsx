import { Container, Row, Button, Dropdown, Col, Image } from "react-bootstrap";
import {
  BellFill,
  BriefcaseFill,
  CaretDownFill,
...
function MyNavbar() {
  ...
  const handleLogin = async (e) => {
    e.preventDefault()
    try {
      const response = await fetch(`http://localhost:3025/api/profiles/session`, {
        method: "POST",
        headers: {
      ...
      const responseGet = await fetch(`http://localhost:3025/api/profiles/${data2.userId}`, {
        headers: {
              ...
              <Row className="d-flex flex-row  justify-content-between">
                ...
                {(!user && !isLoggedIn) ? (
                  ...
                  >
                    ...
                    <Dropdown>
                      <Dropdown.Toggle variant="link" id="dropdown-basic" classname="p-0 custom-toggle">
                        ...
                        <div className="my-3 mx-3">
                          <Row>
                            <Col xs={"auto"} className="pe-0">
                              <Image className="blog-author" src={user.photo} roundedCircle />
                            </Col>
